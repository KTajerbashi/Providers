...
namespace SoapParserWCF.ProxyFactory
{
    public class ProxyFactory
    {
        ...
        public ProxyService ImportService(string WsdlUrl, string Username, string Password, bool IgnoreSSL)
        {
            if (IgnoreSSL) ServicePointManager.ServerCertificateValidationCallback = delegate { return true; };
            else ServicePointManager.ServerCertificateValidationCallback = null;
            ...
            if (Username.IsNotEmpty())
                webRequest.Credentials = new NetworkCredential(Username, Password); //replace with your credentials
            ...
            new SchemaInjection(this.ServiceImporter, serviceDesc, uri, Username, Password);
